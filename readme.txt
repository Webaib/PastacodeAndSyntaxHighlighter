...
Use Pastacode to add code into your posts with the awesome SyntaxHighlighter plugin. So, past'a code!

== Description ==

With PC&SH, you can easily add code into your posts with the awesome SyntaxHighlighter js-library.
